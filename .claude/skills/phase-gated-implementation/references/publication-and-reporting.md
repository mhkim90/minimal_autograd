...
also suffice. The owner need not quote a SHA. Claude Code resolves that identity
to the current plan artifact and records its HEAD internally. Before implementation,
