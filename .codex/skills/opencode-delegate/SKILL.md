...
description: Delegate approved, tedious, or long-running work through OpenCode MCP. Route mechanical work to the configured default, standard work to Luna, and justified difficult preflight to Sol-expert.
---
